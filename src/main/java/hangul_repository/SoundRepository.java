...
public interface SoundRepository {
    Map<String, Character> sound = new HashMap<>() {{
        ...
        put("gon", '곤'); put("gok", '곡'); put("gol", '골'); put("got", '곳'); put("gong", '공');
        put("gwa", '과'); put("got", '곶'); put("gwak", '곽'); put("gwan", '관'); put("gwal", '괄');
        ...
        put("ak", '악'); put("an", '안'); put("al", '알'); put("am", '암'); put("ap", '압');
        put("ang", '앙'); put("ap", '앞'); put("ae", '애'); put("aek", '액'); put("aeng", '앵');
